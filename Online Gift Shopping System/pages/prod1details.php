...
<body >
        ...
        <div class="small-container single-product">
            <div class="row-1">
                <div class="col">
                    <img id="ProductImg" width="100%" src="../images/prod1.jpg">
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod1.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod11.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod12.jpg">
                        </div>
                    </div>
                </div>
                <div class="col">
                <form action="manage_cart.php" method="POST">
                    <h1>Customized Mug by Rinkon</h1>
                    <h4>&#8377;199</h4>
                    <input type="text" style="width: 40%;" placeholder="Enter the name"> 
                    ...
                    <ul style="list-style-type:disc;">
                        ...
                        <li>Made of Ceramic Material</li>    
                        <li>Can hold Approximately 300 ml liquid</li>
                    </ul><br>
                    <p>Personalized gifts help realize the recipient that sender
                         took extra efforts to choose a thoughtful gift for them. Send this personalized
                          mug to your dear ones on special occasions to give them sweet memories for a lifetime.</p>
                        <input type="hidden" name="Item_Name" value="Customized Mug by Rinkon">
                        <input type="hidden" name="Price" value="199">
                        <input type="hidden" name="image" value="../images/prod1.jpg">
                        <input type="hidden" name="link" value="prod1details.php">
                </form>
                </div>
            </div>
        </div>
