...
<body >
        ...
        <div class="small-container single-product">
            <div class="row-1">
                <div class="col">
                    <img id="ProductImg" width="100%" src="../images/prod10.jpg">
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod10.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod101.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod102.jpg">
                        </div>
                    </div>
                </div>
                <div class="col">
                    <form action="manage_cart.php" method="POST">
                        <h1>LuvIt Goodies Chocolates Assorted Gift Pack</h1>
                        <h4>&#8377;466</h4> 
                        <input style="width: 10%;" type="number" name="Quantity" min="1" value="1"> 
                        <button type="submit" name="Add_To_Cart" class="btn">Add to cart</button>
                        <h3>Product Details</h3><br>
                        <ul style="list-style-type:disc;">
                            <li>LuvIt Goodies comes with your favourite LuvIt Chocolates packed in lovely gift carton for Diwali Celebrations!</li>
                            <li>This delicious gift pack is an assortment of 5 of LuvIt’s best products</li>
                            <li>LuvIt Goodies consists of your favourite LuvIt Dairy Rich, LuvIt Chocwich White, LuvIt Loca, LuvIt Crazypops and LuvIt Smackers. Making it the perfect gift for everyone and for every occasion be it festivals, birthdays or just to say I love you!</li>
                            <li>This combo pack is made with 5 units of LuvIt Goodies -134.4g each</li>
                            <li>It makes the perfect Birthday or Deepawali Gift for your friends and family</li>
                        </ul><br>
                        <input type="hidden" name="Item_Name" value="LuvIt Goodies Chocolates Assorted Gift Pack">
                        <input type="hidden" name="Price" value="466">
                        <input type="hidden" name="image" value="../images/prod10.jpg">
                        <input type="hidden" name="link" value="prod10details.php">
                    </form>
                </div>
            </div>
        </div>
