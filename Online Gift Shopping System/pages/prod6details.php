...
<body >
        ...
        <div class="small-container single-product">
            <div class="row-1">
                <div class="col">
                    <img id="ProductImg" width="100%" src="../images/prod6.jpg">
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod6.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod61.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod62.jpg">
                        </div>
                    </div>
                </div>
                <div class="col">
                <form action="manage_cart.php" method="POST">
                    <h1>Customized Name Keychain Stainless Steel</h1>
                    <h4>&#8377;1549</h4>
                    <input type="text" id="name" style="width: 40%;" placeholder="Enter your name">  
                    <input style="width: 10%;" type="number" name="Quantity" min="1"value="1">
                    <br>
                    <div>
                        <label for="Silver" style="display: inline-grid;padding-right: 45px;"><input type="radio" name="color" value="Silver" id="Silver" checked/>
                        Silver</label>
                        <label for="Golden" style="display: inline-grid;"><input type="radio" name="color" value="Golden" id="Golden" />
                        Golden</label>
                    </div>
                    <button type="submit" name="Add_To_Cart" class="btn">Add to cart</button> 
                    <h3>Product Features</h3><br>
                    <ul style="list-style-type:disc;">
                        <li>Personalize the Keychain with a customized name</li>
                        <li>Material: brass metal</li>
                        <li>Colour:Silver/Golden</li>
                        <li>MADE IN INDIA</li>
                    </ul><br>
                    <p>Personalized gifts help realize the recipient that sender took extra 
                        efforts to choose a thoughtful gift for them.<br>
                         Send this Personalized NameKeychain that is specifically made for your loved ones on 
                         special occasions to give them sweet memories for a lifetime.</p>
                         <input type="hidden" name="Item_Name" value="Customized Name Keychain Stainless Steel">
                        <input type="hidden" name="Price" value="1549">
                        <input type="hidden" name="image" value="../images/prod6.jpg">
                        <input type="hidden" name="link" value="prod6details.php">
                </form>            
                </div>
            </div>
        </div>
