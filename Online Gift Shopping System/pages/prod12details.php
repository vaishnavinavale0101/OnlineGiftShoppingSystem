...
<body >
        ...
        <div class="small-container single-product">
            <div class="row-1">
                <div class="col">
                    <img id="ProductImg" width="100%" src="../images/prod12 (2).jpg">
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod12 (2).jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod121.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod122.jpg">
                        </div>
                    </div>
                </div>
                <div class="col">
                    <form action="manage_cart.php" method="POST">
                        <h1>Chocholik Belgium Dark Almond Rocks </h1>
                        <h4>&#8377;499</h4> 
                        <input style="width: 10%;" type="number" name="Quantity" min="1" value="1"> 
                        <button type="submit" name="Add_To_Cart" class="btn">Add to cart</button>
                        <h3>Product Details</h3><br>
                        <ul style="list-style-type:disc;">
                            <li>Mouth watering luxury rock chocolates. We are the only company in india to provide special melt proof packing for all our items all across india.</li>
                            <li>High quality premium rock chocolate gift box</li>
                            <li>Chocholik luxury rock chocolates</li>
                            <li>100% veg no eggs</li>
                            <li>Item weight: 100 grams</li>
                            <li>Shelf life: 180 days</li>
                            <li>Package contents: belgium dark almond rocks - finest chocolate delight or gift for someone chocolate bar</li>
                        </ul><br>
                        <input type="hidden" name="Item_Name" value="Chocholik Belgium Dark Almond Rocks">
                        <input type="hidden" name="Price" value="499">
                        <input type="hidden" name="image" value="../images/prod12 (2).jpg">
                        <input type="hidden" name="link" value="prod12details.php">
                    </form>
                </div>
            </div>
        </div>
