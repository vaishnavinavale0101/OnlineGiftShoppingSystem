...
<body>
    <div class="header" style="background: white;">
        ...
        <div class="small-container single-product">
            <div class="row-1">
                <div class="col">
                    <img id="ProductImg" width="100%" src="../images/prod5.jpg">
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod5.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod51.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod52.jpg">
                        </div>
                    </div>
                </div>
                <div class="col">
                <form action="manage_cart.php" method="POST">
                    <h1>Baggit Black HandBag for Women</h1>
                    <h4>&#8377;669</h4>
                    <input style="width: 10%;" type="number" name="Quantity" min="1" value="1"> 
                    <button type="submit" name="Add_To_Cart" class="btn">Add to cart</button> 
                    <h3>Product Features</h3><br>
                    <ul style="list-style-type:disc;">
                        <li>Material: Vegan Cactus</li>
                        <li>Interior Material: Recycled Polyester</li>
                        <li>Details: 1 Removable Zipper Pouch</li>
                        <li>Measurements: 15.5" L x 5" W x 11.5" H</li>
                        <li>Handle Strap Description: 2 Adjustable & Detachable Shoulder Straps</li>
                        <li>Primary Color: Brown</li>
                    </ul><br>
                        <p> Stylish dome satchel bag for every occasion.<br>
                            Top zip closure for safety & security and comfortable Baggit tote bag with dual flat shoulder straps 
                            which provides comfort & convenience while travelling.<br>
                            A stylish purse to carry your day, Interior has 2 slip pockets alongside 1 zip pocket, providing plenty multi-purpose
                             Storage for keeping phone, portable charger, keys, hairbrush, wallet, sunglasses, etc.
                        </p>
                        <input type="hidden" name="Item_Name" value="Baggit Black HandBag for Women">
                        <input type="hidden" name="Price" value="669">
                        <input type="hidden" name="image" value="../images/prod5.jpg">
                        <input type="hidden" name="link" value="prod5details.php">
                </form>
                </div>
            </div>
        </div>
