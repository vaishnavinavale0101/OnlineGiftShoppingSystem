...
<body >
        ...
        <div class="small-container single-product">
            <div class="row-1">
                <div class="col">
                    <img id="ProductImg" width="100%" src="../images/latest3.jpg">
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/latest3.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/latest31.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/latest32.jpg">
                        </div>
                    </div>
                </div>
                <div class="col">
                <form action="manage_cart.php" method="POST">
                    <h1>Customized Date Bracelet</h1>
                    <h4>&#8377;899</h4> 
                   <input type="date" style="width: 40%;">
                    ...
                    <ul style="list-style-type:disc;">
                        ...
                        <li>Format: DD/MM/YY</li>
                    </ul><br>
                    <p>Turn a significant date into a sweet and dainty one-of-a-kind bracelet.
                         Whether it be a wedding date, anniversary, a child or spouse's birthday, or a graduation
                         , mark it with this special piece. </p>
                        <input type="hidden" name="Item_Name" value="Customized Date Bracelet">
                        <input type="hidden" name="Price" value="899">
                        <input type="hidden" name="image" value="../images/latest3.jpg">
                        <input type="hidden" name="link" value="latest3details.php">
                </form>
                </div>
            </div>
        </div>
