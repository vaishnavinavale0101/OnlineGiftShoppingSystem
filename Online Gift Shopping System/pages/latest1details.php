...
<body >
        ...
        <div class="small-container single-product">
            <div class="row-1">
                <div class="col">
                    <img id="ProductImg" width="100%" src="../images/latest1.jpg">
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/latest1.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/latest11.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/latest12.jpg">
                        </div>
                    </div>
                </div>
                <div class="col">
                    <form action="manage_cart.php" method="POST">
                        <h1>Butterfly Golden Bracelet by Diva</h1>
                        <h4>&#8377;299</h4> 
                        <input style="width: 10%;" type="number" name="Quantity" min="1" value="1"> 
                        <button type="submit" name="Add_To_Cart" class="btn">Add to cart</button>
                        <h3>Product Details</h3><br>
                        <ul style="list-style-type:disc">
                            <li>Butterflies tell you to grow out of your comfort zone. They teach you that beautiful things lie beyond the box.
                                And butterflies inspire the beauties like this Wired Silver Butterfly Bracelet.</li>
                            <li>Wired Silver Butterfly Bracelet is handcrafted with love, just for YOU. 
                                The tiny links are super dainty and the wire butterfly charm is simply unique. 
                                Constant reminder to keep pushing and keeping growing.</li>    
                            <li>Sterling silver with 925 hallmark</li>
                            <li>Hypoallergenic - Perfect for sensitive skin</li>
                            <li>Rhodium e-coat to prevent tarnish</li>
                            <li>Comes with the DIVA Jewellery kit and authenticity certificate</li>   
                        </ul><br>
                        <input type="hidden" name="Item_Name" value="Butterfly Golden Bracelet by Diva">
                        <input type="hidden" name="Price" value="299">
                        <input type="hidden" name="image" value="../images/latest1.jpg">
                        <input type="hidden" name="link" value="latest1details.php">
                    </form>
                </div>
            </div>
        </div>
