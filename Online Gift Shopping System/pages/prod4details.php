...
<body >
        ...
        <div class="small-container single-product">
            <div class="row-1">
                <div class="col">
                    <img id="ProductImg" width="100%" src="../images/prod4.jpg">
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod4.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod41.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod42.jpg">
                        </div>
                    </div>
                </div>
                <div class="col">
                <form action="manage_cart.php" method="POST">
                    <h1>Combo of 2 Watches for Women from SK</h1>
                    <h4>&#8377;699</h4>
                    <input style="width: 10%;" type="number" name="Quantity" min="1" value="1"> 
                    <button type="submit" name="Add_To_Cart" class="btn">Add to cart</button> 
                    <h3>Product Features</h3><br>
                    <ul style="list-style-type:disc;">
                        <li>Type: Quartz Wristwatches</li> 
                        <li>Diameter: 36mm</li>
                        <li>Case Shape: Round</li>
                        <li>Feature: Water Resistant,Shock Resistant</li>
                        <li>Case Thickness: 9.5mm</li>
                        <li>Band Width: 25mm</li>
                        <li>Case Material: Stainless Steel</li>
                    </ul><br>
                        <p> Accurate Time Keeping:High quality Japanese movement with analog display, provide precise time keeping.Clean and simple dial makes it easy to tell the time at a quick glance<br>
                        Exquisite Adjustable Band: The Stainless Steel band is smooth and comfortable on your wrist, comes with a metal adjust tool, very easy and convenient to adjust the band length as you want<br>
                        BEST GIFTS FOR WOMEN - This analog watch comes in box, it is perfect gift for mom, girlfriend, daughter, wife,friend, business partner.
                        </p>
                        <input type="hidden" name="Item_Name" value="Combo of 2 Watches for Women from SK">
                        <input type="hidden" name="Price" value="699">
                        <input type="hidden" name="image" value="../images/prod4.jpg">
                        <input type="hidden" name="link" value="prod4details.php">
                </form>
                </div>
            </div>
        </div>
