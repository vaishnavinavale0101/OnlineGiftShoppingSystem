...
<body >
        ...
        <div class="small-container single-product">
            <div class="row-1">
                <div class="col">
                    <img id="ProductImg" width="100%" src="../images/prod11 (2).jpg">
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod11 (2).jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod111.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod112.jpg">
                        </div>
                    </div>
                </div>
                <div class="col">
                    <form action="manage_cart.php" method="POST">
                    <h1>Cadbury Celebrations Chocolate Gift Pack </h1>
                    <h4>&#8377;262</h4> 
                    <input style="width: 10%;" type="number" name="Quantity" min="1" value="1"> 
                    <button type="submit" name="Add_To_Cart" class="btn">Add to cart</button>
                    <h3>Product Details</h3><br>
                    <ul style="list-style-type:disc;">
                        <li>A special collection of delicious Cadbury chocolates to surprise your loved ones</li>
                        <li>Flavor Name: Chocolate</li>
                        <li>This assorted pack contains 1 unit of 5-star 3D-42g, 1 unit of Cadbury dairy milk-23g, 2 units of Cadbury dairy milk Crackle-36g, 2 units of Cadbury dairy milk Fruit & Nut-36g and 2 units of Cadbury dairy milk Roasted Almond-36g</li>
                        <li>Cadbury Premium selection is packed and delivered with frozen gel packs (reusable) to maintain temperature & quality during transit</li>
                        <li>Hurry up! Celebrate this Diwali by gifting Cadbury Premium selection to your loved ones</li>
                    </ul><br>
                    <input type="hidden" name="Item_Name" value="Cadbury Celebrations Chocolate Gift Pack ">
                    <input type="hidden" name="Price" value="262">
                    <input type="hidden" name="image" value="../images/prod11 (2).jpg">
                    <input type="hidden" name="link" value="prod11details.php">
                    </from>
                </div>
            </div>
        </div>
