...
<body >
        ...
        <div class="small-container single-product">
            <div class="row-1">
                <div class="col">
                    <img id="ProductImg" width="100%" src="../images/prod2.jpg">
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod2.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod21.jpg">
                        </div>
                        <div class="small-img-col">
                            <img class="small-img" width="100%" src="../images/prod22.jpg">
                        </div>
                    </div>
                </div>
                <div class="col">
                <form action="manage_cart.php" method="POST">
                    <h1>Chocolate Oreo Cake</h1>
                    <h4>&#8377;899</h4> 
                    ...
                    <p>A super delicious creamy half kg chocolate cake with a touch of our favourite cream sandwich cookies.</p>
                    <input type="hidden" name="Item_Name" value="Chocolate Oreo Cake">
                    <input type="hidden" name="Price" value="899">
                    <input type="hidden" name="image" value="../images/prod2.jpg">
                    <input type="hidden" name="link" value="prod2details.php">
                </form>
                </div>
            </div>
        </div>
